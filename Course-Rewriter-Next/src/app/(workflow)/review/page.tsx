...
export default function ReviewPage() {
  ...
  const [statusFilter, setStatusFilter] = useState<ItemStatus | "all">("rewritten");
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="border rounded-lg overflow-hidden bg-white">
                <iframe
                  srcDoc={currentItem.html || "<p>(empty)</p>"}
                  className="w-full"
                  style={{ height: "600px" }}
          ...
          <Card>
            ...
            <CardContent>
              <div className="border rounded-lg overflow-hidden bg-white">
                <iframe
                  srcDoc={currentItem.rewrittenHtml || "<p>(not yet rewritten)</p>"}
                  className="w-full"
                  style={{ height: "600px" }}
                  sandbox="allow-same-origin"
